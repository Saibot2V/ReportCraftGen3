import { Settings } from "lucide-react";
    ...
    export const Header = ({
      ...
      return (
        <header className="w-full bg-transparent p-4 text-white flex justify-between items-center">
          <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-red-500">ReportCraft</h1>
          <div className="flex gap-2">
            <Button variant="ghost" onClick={handleLogout} className="text-foreground hover:text-foreground/80">
              Logout
            </Button>
            <Button variant="ghost" onClick={onDownloadPdf} className="text-foreground hover:text-foreground/80">
              PDF Download
            </Button>
            <Button
              variant="ghost"
